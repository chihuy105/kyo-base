...
class Dimens {
  ...
  static const EdgeInsets edge_btn_wide =
  ...
  static const EdgeInsets edge_x_XS = EdgeInsets.symmetric(horizontal: pad_XS2);
  ...
  static const EdgeInsets edge_XS = EdgeInsets.all(pad_XS2);
